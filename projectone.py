...
tagoruser=st.text_input("Enter the User_Hashtag:")
fromdate=st.date_input("From_date(YYYY-MM-DD):")
enddate=st.date_input("End_date(YYYY-MM-DD):")
tweets_count=st.number_input("enter the count:",min_value=1,max_value=100)
